...
FROM loans
	...
	LEFT JOIN loan_sdg_data ON loan_sdg_data.loan_id = loans.id
	LEFT JOIN presentation_compliance_checks ON presentation_compliance_checks.loan_id = loans.id AND presentation_compliance_checks.presentable_at = loan_versions.presentable_at
WHERE
